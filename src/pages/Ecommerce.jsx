  ...
  return (
    <div className='mt-1'>
      <div className='flex flex-wrap lg:flex-nowrap justify-center'>
        ...
        p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center'>
          <div className='flex justify-between items-center'>
            <div>
              ...
              <p className='text-2xl'>Ghc31,458.35</p>
            </div>
          </div>
          <div className='mt-6'>
            <Button
        ...
        <div className='flex m-4 px-3 flex-wrap justify-center gap-1 items-center'>
          {earningData.map((item) => (
            <div
              key={item.title}
              className='bg-white dark:text-gray-200 dark:bg-secondary-dark-bg
             p-4 px-6 pt-9 rounded-2xl'>
              <button
                type='button'
      ...
      <div className='flex gap-10 flex-wrap justify-center'>
        <div className='bg-white dark:text-gray-200 
           dark:bg-secondary-dark-bg m-7 p-7 rounded-2xl md:w-780'>
          ...
          <div className='mt-10 flex gap-10 flex-wrap justify-between'>
            <div className='border-r-1 border-color m-4 pr-10'>
              <div>
                <p>
                  <span className='text-3xl font-semibold'>Ghc43,876</span>
                  <span className='p-1.5 hover:drop-shadow-xl
                  cursor-pointer rounded-full text-white
                  bg-green-400 ml-3 text-xs'>43%</span>
                </p>
                <p className='text-gray-500 mt-1'>Budget</p>
              </div>
              <div className='mt-8'>
                <p>
                  <span className='text-3xl font-semibold'>Ghc37,876</span>
